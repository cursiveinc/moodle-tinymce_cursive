...
class userreportform extends moodleform
{
    public function definition()
    {
        ...
        $mform->addElement('autocomplete', 'modulename', get_string('modulename', 'tiny_cursive'), $modules, $attributes);
        $mform->setType('modulename', PARAM_RAW);

        $mform->addElement('autocomplete', 'username', get_string('userename', 'tiny_cursive'), $users, $attributes);
